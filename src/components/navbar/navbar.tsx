      ...
      <>
          <header className="bg-red-400 flex justify-center">
              <div className="container flex flex-row items-center justify-around text-white font-bold">
                  ...
                  <Link className='text-4xl flex items-center gap-4' to='/home'><img className="h-16" src="/src/assets/images/1.png" alt="Logo Farmácia" /></Link>
                  </div>

                  <div className="flex-1 flex justify-center items-center relative w-30 text-black pl-9">
                        <form>
                            <input className="h-9 w-96 rounded-lg px-4 py-4 focus:outline-none"
                                type="search"
                  ...
                  <div className="flex flex-row justify-end">
                    <nav>
                        <ul className="flex flex-row justify-center items-center py-10">
                            <Link to='/categorias' className="mx-3">Categorias</Link>
                            <Link to='/cadastrarcategoria' className="mx-3">Cadastrar Categoria</Link>
                        </ul>
                    </nav>
